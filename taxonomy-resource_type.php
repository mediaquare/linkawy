<?php
/**
 * Taxonomy Archive: resource_type
 *
 * Same layout as resources archive (hero + filters + grid). Used for URLs like /resources/term-slug/
 *
 * @package Linkawy
 */
...
?>
    ...
    <section class="blog-grid-section">
        <div class="container">
            ...
            <?php else : ?>
                <p class="no-posts"><?php _e('لا توجد موارد في هذا النوع.', 'linkawy'); ?></p>
            <?php endif; ?>
        </div>
    </section>
