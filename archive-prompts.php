<?php
/**
 * Archive Template for Prompts CPT
 *
 * Library/Discovery landing page: hero, AJAX search, filter, grid, pagination.
 *
 * @package Linkawy
 */
...
<section class="service-hero resource-hero-saas prompt-hero-no-media prompts-resource-hero">
    ...
    <div class="container service-hero-inner">
        <div class="service-hero-content">
            ...
            <h1 class="service-hero-title"><?php _e('أوامر الذكاء الاصطناعى لـ التسويق بالمحتوى والـ SEO', 'linkawy'); ?></h1>
            <p class="service-hero-subtitle"><?php _e('مكتبة قوالب مطالبات الذكاء الاصطناعي الجهازة (AI Prompts) لتسريع إنتاجيتك وإبداعك. اكتشف أوامر الذكاء الاصطناعي الجاهزة لكتابة المحتوى وتحسين محركات البحث والمزيد.', 'linkawy'); ?></p>
        ...
        <div id="prompts-grid-wrap" class="prompts-grid-wrap">
            ...
            <div id="prompts-grid" class="blog-grid">
                <?php if (have_posts()) : ?>
                    ...
                    ?>
                <?php else : ?>
                    <p class="no-posts"><?php _e('لا توجد برومبتات حتى الآن.', 'linkawy'); ?></p>
                <?php endif; ?>
            </div>
